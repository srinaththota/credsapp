...
goog.exportSymbol('proto.io.iohk.test.protos.GetUsersResponse', null, global);
goog.exportSymbol('proto.io.iohk.test.protos.RepeatedCredentials', null, global);
/**
 ...
 * @constructor
 */
proto.io.iohk.test.protos.RepeatedCredentials = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.io.iohk.test.protos.RepeatedCredentials.repeatedFields_, null);
};
goog.inherits(proto.io.iohk.test.protos.RepeatedCredentials, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.io.iohk.test.protos.RepeatedCredentials.displayName = 'proto.io.iohk.test.protos.RepeatedCredentials';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.io.iohk.test.protos.GetUsersResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.io.iohk.test.protos.GetUsersResponse.repeatedFields_, null);
};
goog.inherits(proto.io.iohk.test.protos.GetUsersResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.io.iohk.test.protos.GetUsersResponse.displayName = 'proto.io.iohk.test.protos.GetUsersResponse';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @const
 */
proto.io.iohk.test.protos.RepeatedCredentials.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.io.iohk.test.protos.RepeatedCredentials.prototype.toObject = function(opt_includeInstance) {
  return proto.io.iohk.test.protos.RepeatedCredentials.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.io.iohk.test.protos.RepeatedCredentials} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.iohk.test.protos.RepeatedCredentials.toObject = function(includeInstance, msg) {
  var f, obj = {
    credentialsList: jspb.Message.toObjectList(msg.getCredentialsList(),
    proto.io.iohk.test.protos.Credential.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.io.iohk.test.protos.RepeatedCredentials}
 */
proto.io.iohk.test.protos.RepeatedCredentials.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.io.iohk.test.protos.RepeatedCredentials;
  return proto.io.iohk.test.protos.RepeatedCredentials.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.io.iohk.test.protos.RepeatedCredentials} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.io.iohk.test.protos.RepeatedCredentials}
 */
proto.io.iohk.test.protos.RepeatedCredentials.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.io.iohk.test.protos.RepeatedCredentials.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.io.iohk.test.protos.RepeatedCredentials.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.io.iohk.test.protos.RepeatedCredentials} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.iohk.test.protos.RepeatedCredentials.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCredentialsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.io.iohk.test.protos.Credential>}
 */
proto.io.iohk.test.protos.RepeatedCredentials.prototype.getCredentialsList = function() {
  return /** @type{!Array<!proto.io.iohk.test.protos.Credential>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.io.iohk.test.protos.Credential, 1));
};
...
/**
 * @param {!Array<!proto.io.iohk.test.protos.Credential>} value
 * @return {!proto.io.iohk.test.protos.RepeatedCredentials} returns this
*/
proto.io.iohk.test.protos.RepeatedCredentials.prototype.setCredentialsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.io.iohk.test.protos.Credential}
 */
proto.io.iohk.test.protos.RepeatedCredentials.prototype.addCredentials = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.io.iohk.test.protos.Credential, opt_index);
};
 ...
 * @return {!proto.io.iohk.test.protos.RepeatedCredentials} returns this
 */
proto.io.iohk.test.protos.RepeatedCredentials.prototype.clearCredentialsList = function() {
  return this.setCredentialsList([]);
};
 ...
 * @const
 */
proto.io.iohk.test.protos.GetUsersResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.io.iohk.test.protos.GetUsersResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.io.iohk.test.protos.GetUsersResponse.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.io.iohk.test.protos.GetUsersResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.iohk.test.protos.GetUsersResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    credentialsList: jspb.Message.toObjectList(msg.getCredentialsList(),
    proto.io.iohk.test.protos.Credential.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.io.iohk.test.protos.GetUsersResponse}
 */
proto.io.iohk.test.protos.GetUsersResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.io.iohk.test.protos.GetUsersResponse;
  return proto.io.iohk.test.protos.GetUsersResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.io.iohk.test.protos.GetUsersResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.io.iohk.test.protos.GetUsersResponse}
 */
proto.io.iohk.test.protos.GetUsersResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.io.iohk.test.protos.GetUsersResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.io.iohk.test.protos.GetUsersResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.io.iohk.test.protos.GetUsersResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.io.iohk.test.protos.GetUsersResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getCredentialsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
 ...
 * @return {!Array<!proto.io.iohk.test.protos.Credential>}
 */
proto.io.iohk.test.protos.GetUsersResponse.prototype.getCredentialsList = function() {
  return /** @type{!Array<!proto.io.iohk.test.protos.Credential>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.io.iohk.test.protos.Credential, 1));
};
...
/**
 * @param {!Array<!proto.io.iohk.test.protos.Credential>} value
 * @return {!proto.io.iohk.test.protos.GetUsersResponse} returns this
*/
proto.io.iohk.test.protos.GetUsersResponse.prototype.setCredentialsList = function(value) {
  return jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 * @return {!proto.io.iohk.test.protos.Credential}
 */
proto.io.iohk.test.protos.GetUsersResponse.prototype.addCredentials = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.io.iohk.test.protos.Credential, opt_index);
};
 ...
 * @return {!proto.io.iohk.test.protos.GetUsersResponse} returns this
 */
proto.io.iohk.test.protos.GetUsersResponse.prototype.clearCredentialsList = function() {
  return this.setCredentialsList([]);
};
